        ...
        <div className="daily-verse">
          {verse.loading ? (
            ...
            <>
              ...
              <p className="verse-reference">— {verse.reference}</p>
				...
				<div className="footer-socials">
					...
					<a href="mailto:zeus.sulit@gmail.com" aria-label="Email">
			...
			<div className="footer-bottom">
				<span>© 2025 Zeus Sulit. All rights reserved.</span>
				<button className="footer-top" onClick={handleBackToTop} aria-label="Back to Top">↑ Back to Top</button>
			</div>
		</footer>
	);
}
